                        ...
                        <div className="section-title">
                            ...
                            <ul className="nav nav-tabs">
                                <li className="nav-item">
                                    <a className="nav-link active" data-bs-toggle="tab" href="#home">SPECIAL
                                        PRODUCTS</a>
                                </li>
                                <li className="nav-item">
                            ...
                            <div className="tab-pane fade show active" id="home">
                                            ...
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-4.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-04.jpg"
                                                    ...
                                                    <div className="pro-icn">
                                                        ...
                                                        <a href="cart.html" className="w-c-q-icn"><i
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-7.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-07.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-3.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-03.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-1.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-01.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-5.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-05.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-6.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-06.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-8.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-08.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-9.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-09.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-10.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-010.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
                                ...
                                <div className="swiper-buttons">
                                    <div className="content-buttons">
                                        ...
                                        <div className="swiper-button-prev swiper-button-disabled" tabIndex="0"
                                             role="button"
                                        ...
                                        <div className="swiper-slide">
                                            <div className="h-t-pro">
                                                <div className="tred-pro">
                                                    <div className="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="/asset/image/pro/pro-img-2.jpg" alt="pro-img1"
                                                                 className="img-fluid"/>
                                                            <img src="/asset/image/pro/pro-img-02.jpg"
                                                                 alt="additional image"
                                                                 className="img-fluid additional-image"/>
                                                        </a>
                                                    </div>
