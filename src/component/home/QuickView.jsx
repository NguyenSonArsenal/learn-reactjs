                        ...
                        <div className="quick-veiw-area">
                            <div className="quick-image">
                                <div className="tab-content">
                                    <div className="tab-pane fade show active" id="image-1">
                                        <a href="javascript:void(0)" className="long-img">
                                            <img src="/asset/image/pro-page-image/pro-page-image.jpg"
                                                 className="img-fluid"
                                                 alt="image"/>
                                        </a>
                                    </div>
                                ...
                                <ul className="nav nav-tabs quick-slider owl-carousel owl-theme">
                                    <li className="nav-item items">
                                        <a className="nav-link active" data-bs-toggle="tab" href="#image-1"><img
                                            src="/asset/image/pro-page-image/image1.jpg" className="img-fluid"
                                            alt="image"/></a>
                                    </li>
                                    <li className="nav-item items">
                                        <a className="nav-link" data-bs-toggle="tab" href="#image-2"><img
                                            src="/asset/image/pro-page-image/image2.jpg" className="img-fluid"
                                            alt="image"/></a>
                                    </li>
                                    <li className="nav-item items">
                                        <a className="nav-link" data-bs-toggle="tab" href="#image-3"><img
                                            src="/asset/image/pro-page-image/image3.jpg" className="img-fluid"
                                            alt="image"/></a>
                                    </li>
                                    <li className="nav-item items">
                                        <a className="nav-link" data-bs-toggle="tab" href="#image-4"><img
                                            src="/asset/image/pro-page-image/image4.jpg" className="img-fluid"
                                            alt="image"/></a>
                                    </li>
                                    <li className="nav-item items">
                                        <a className="nav-link" data-bs-toggle="tab" href="#image-5"><img
                                            src="/asset/image/pro-page-image/image5.jpg" className="img-fluid"
                                            alt="image"/></a>
                                    </li>
                                    <li className="nav-item items">
                                        <a className="nav-link" data-bs-toggle="tab" href="#image-6"><img
                                            src="/asset/image/pro-page-image/image6.jpg" className="img-fluid"
                                            alt="image"/></a>
                                    </li>
                                    <li className="nav-item items">
                                        <a className="nav-link" data-bs-toggle="tab" href="#image-7"><img
                                            src="/asset/image/pro-page-image/image8.jpg" className="img-fluid"
                                            alt="image"/></a>
                                    </li>
                                    <li className="nav-item items">
                                        <a className="nav-link" data-bs-toggle="tab" href="#image-8"><img
                                            src="/asset/image/pro-page-image/image7.jpg" className="img-fluid"
                                            alt="image"/></a>
                                    </li>
                                </ul>
                            </div>
                            <div className="quick-caption">
                                ...
                                <span>
                                    ...
                                    <a href="cart.html" className="quick-cart"><i
                                        className="fa fa-shopping-bag"></i></a>
                                    <a href="wishlist.html" className="quick-wishlist"><i
