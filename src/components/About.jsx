	...
	return <>
		...
		<div className="container">
			<div id="content">
				<div className="our-history">
					...
					<div className="history-slider">
						<div className="history-navigation">
							<a data-slide-index="0" href="blog_with_2sidebars_type_e.html" className="circle"><span
								className="auto-center">2003</span></a>
							<a data-slide-index="1" href="blog_with_2sidebars_type_e.html" className="circle"><span
								className="auto-center">2004</span></a>
							<a data-slide-index="2" href="blog_with_2sidebars_type_e.html" className="circle"><span
								className="auto-center">2005</span></a>
							<a data-slide-index="3" href="blog_with_2sidebars_type_e.html" className="circle"><span
								className="auto-center">2007</span></a>
							<a data-slide-index="4" href="blog_with_2sidebars_type_e.html" className="circle"><span
								className="auto-center">2009</span></a>
							<a data-slide-index="5" href="blog_with_2sidebars_type_e.html" className="circle"><span
								className="auto-center">2011</span></a>
							<a data-slide-index="6" href="blog_with_2sidebars_type_e.html" className="circle"><span
								className="auto-center">2014</span></a>
						</div>
				...
				<div className="space20">&nbsp;</div>
				<p className="text-center wow fadeInLeft">Ut enim ad minim veniam, quis nostrud exercitation ullamco
				...
				<div className="row">
					...
					<div className="col-sm-2 col-sm-push-2">
						<div className="beta-counter">
							...
							<p className="beta-counter-value timer numbers" data-to="258934"
								 data-speed="2000">258934</p>
				...
				<p className="text-center wow fadeInRight">Nemo enims voluptatem quia volupas sit aspe aut odit aut
					fugit, sed quia <br/>consequuntur magni dolores.</p>
				<div className="space20">&nbsp;</div>
				<div className="row">
					<div className="col-sm-6 wow fadeInLeft">
						<div className="beta-person media">
							
							<img className="pull-left" src="./asset/images/person2.jpg" alt=""/>
							...
							<div className="media-body beta-person-body">
								...
								<a href="single_type_gallery.html">View projects <i
					...
					<div className="col-sm-6 wow fadeInRight">
						<div className="beta-person media ">
							...
							<img className="pull-left" src="./asset/images/person3.jpg" alt=""/>
				...
				<p className="text-center wow fadeInUp">Nemo enims voluptatem quia volupas sit aspe aut odit aut fugit,
					sed quia <br/>consequuntur magni dolores.</p>
				<div className="space20">&nbsp;</div>
				<div className="row">
